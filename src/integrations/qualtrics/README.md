...
README.md - Main documentation file for the TrackMaster Qualtrics integration.
Author(s): Author(s): Gabriel Mongefranco; Victoria Bennett; Conni Harrigan; et. all.
Created: 2025-10-11
Last Modified: 2026-06-03
Summary: Documentation for the TrackMaster Qualtrics integration, which allows sending survey responses from Qualtrics to TrackMaster via email and Power Automate.
